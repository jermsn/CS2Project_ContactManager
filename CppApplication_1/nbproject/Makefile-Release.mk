...
${OBJECTDIR}/_ext/5c0/ClientContact.o: ../ClientContact.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/ClientContact.o ../ClientContact.cpp

${OBJECTDIR}/_ext/5c0/ContactImp.o: ../ContactImp.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/ContactImp.o ../ContactImp.cpp

${OBJECTDIR}/_ext/5c0/DateImp.o: ../DateImp.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/DateImp.o ../DateImp.cpp

${OBJECTDIR}/_ext/5c0/Functions.o: ../Functions.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/Functions.o ../Functions.cpp

${OBJECTDIR}/_ext/5c0/PersonalContact.o: ../PersonalContact.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/PersonalContact.o ../PersonalContact.cpp

${OBJECTDIR}/_ext/5c0/PhoneImpNumberImp.o: ../PhoneImpNumberImp.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/PhoneImpNumberImp.o ../PhoneImpNumberImp.cpp

${OBJECTDIR}/_ext/5c0/RelativeContact.o: ../RelativeContact.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/RelativeContact.o ../RelativeContact.cpp

${OBJECTDIR}/_ext/5c0/WorkContact.o: ../WorkContact.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/WorkContact.o ../WorkContact.cpp
